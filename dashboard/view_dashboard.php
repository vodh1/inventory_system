<div class="p-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold dark:text-white"><?php echo $total_items; ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold dark:text-white"><?php echo $items_borrowed; ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold dark:text-white"><?php echo $overdue_items; ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold dark:text-white"><?php echo $active_users; ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    <h3 class="text-lg font-semibold mb-4 dark:text-white">Borrowing Trends</h3>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                    <h3 class="text-lg font-semibold mb-4 dark:text-white">Equipment by Category</h3>
                    <div class="relative h-80">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <td class="py-3 dark:text-white"><?php echo htmlspecialchars($activity['equipment_name']); ?></td>
                                <td class="py-3 dark:text-white"><?php echo htmlspecialchars($activity['borrower_name']); ?></td>
                                <td class="py-3 dark:text-white"><?php echo htmlspecialchars($activity['department']); ?></td>
                                <td class="py-3">
                                ...
                                <td class="py-3 dark:text-white"><?php echo date('M d, Y', strtotime($activity['borrow_date'])); ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
